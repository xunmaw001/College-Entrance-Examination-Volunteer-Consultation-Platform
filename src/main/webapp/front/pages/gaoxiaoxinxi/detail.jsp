			...
			<div class="data-detail" :style='{"width":"90%","margin":"10px auto","position":"relative","background":"none"}'>
				<div :style='{"padding":"10px 0 0px 0px","boxShadow":"0px 0px 0px #eee","borderColor":"#e6e6e6","overflow":"hidden","borderRadius":"4px","flexWrap":"wrap","background":"rgba(255,255,255,.6)","borderWidth":"1px","display":"flex","position":"relative","borderStyle":"solid","justifyContent":"space-between"}'>
					...
					<div :style='{"minHeight":"500px","padding":"20px 20px 20px","margin":"0px 0px 0 0px","borderColor":"#e6e6e6","background":"rgba(255,255,255,.0)","borderWidth":"0px","flex":"1","width":"48%","borderStyle":"solid","order":"4"}'>
						...
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>院校类型：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.yuanxiaoleixing}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>官方网址：</div>
							<div @click="linkOthers(detail.guanfangwangzhi)" :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.guanfangwangzhi}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>办学类型：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.banxueleixing}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>师资队伍：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.shiziduiwu}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>环境介绍：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.huanjingjieshao}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>历年分数线：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.linianfenshuxian}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>人才培养：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.rencaipeiyang}}
							</div>
						</div>
						...
						<div class="detail-item" :style='{"padding":"10px 0","flexWrap":"wrap","background":"none","display":"flex"}'>
							...
							<button :style='{"border":"0px solid #b8d7f2","cursor":"pointer","padding":"0 10px","margin":"0 5px 0px 0","outline":"none","color":"#333","borderRadius":"4px","background":"#b9f4e3","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' v-if="isAuth('gaoxiaoxinxi','简章')" @click="onAcrossTap('zhaoshengjianzhang','','')" type="button" class="layui-btn">
								简章
							</button>
							<button :style='{"border":"0px solid #b8d7f2","cursor":"pointer","padding":"0 10px","margin":"0 5px 0px 0","outline":"none","color":"#333","borderRadius":"4px","background":"#b9f4e3","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' v-if="isAuth('gaoxiaoxinxi','专业')" @click="onAcrossTap('zhuanyejianxun','','')" type="button" class="layui-btn">
								专业
							</button>
							<button :style='{"border":"0px solid #b8d7f2","cursor":"pointer","padding":"0 10px","margin":"0 5px 0px 0","outline":"none","color":"#333","borderRadius":"4px","background":"#b9f4e3","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' v-if="isAuth('gaoxiaoxinxi','录取')" @click="onAcrossTap('luquxinxi','','')" type="button" class="layui-btn">
								录取
							</button>
					...
					<div v-if="true" class="hot" :style='{"padding":"20px 20px 0","margin":"0px auto 0","background":"#fff","width":"calc(51% - 0px)","position":"relative","height":"auto","order":"2"}'>
					  ...
					  <div :style='{"padding":"10px 10px 0","margin":"10px 0 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
					    <div v-for="item in hotList" :key="item" :style='{"border":"1px solid #e6e6e6","padding":"10px","margin":"0 0 20px","borderRadius":"4px","background":"#fff","width":"48%","height":"auto"}' @click="jump('../gaoxiaoxinxi/detail.jsp?id='+item.id)">
					      <img :style='{"cursor":"pointer","padding":"0px","borderColor":"#c7eec2","objectFit":"cover","borderRadius":"8px","borderWidth":"0px","background":"#fff","display":"block","width":"100%","borderStyle":"solid","height":"150px"}' :src="item.fengmiantupian?(baseurl+item.fengmiantupian.split(',')[0]):''" alt="">
					      <div :style='{"cursor":"pointer","padding":"4px 5px 4px","borderColor":"#eee","color":"#3d74c0","background":"none","borderWidth":"0 0 0px","lineHeight":"24px","fontSize":"14px","borderStyle":"solid"}'>{{item.gaoxiaomingcheng}}</div>
					      <div :style='{"cursor":"pointer","padding":"4px 5px 4px","borderColor":"#eee","color":"#3d74c0","background":"none","borderWidth":"0 0 0px","lineHeight":"24px","fontSize":"14px","borderStyle":"solid"}'>{{item.yuanxiaoleixing}}</div>
					      <div :style='{"cursor":"pointer","padding":"4px 5px 4px","borderColor":"#eee","color":"#3d74c0","background":"none","borderWidth":"0 0 0px","lineHeight":"24px","fontSize":"14px","borderStyle":"solid"}'>{{item.banxueleixing}}</div>
				...
				<div class="layui-tab layui-tab-card" :style='{"boxShadow":"0 0px 0px rgb(0 0 0 / 30%)","padding":"10px","margin":"20px 0 0","borderColor":"#e6e6e6","overflow":"hidden","borderRadius":"4px","background":"rgba(255,255,255,1)","borderWidth":"1px","width":"100%","clear":"both","borderStyle":"solid","order":"10"}'>
					...
					<div :style='{"padding":"15px","background":"#fff"}' class="layui-tab-content">
						...
						<div class="layui-tab-item layui-show">
							<div v-html="detail.xuexiaogaikuang"></div>
						</div>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable,statusColumnName,tips,statusColumnValue){
						localStorage.setItem('crossTable',`gaoxiaoxinxi`);
					...
					storeUp() {
						layui.http.request('storeup/list', 'get', {
							...
							layui.http.requestJson('storeup/save', 'post', {
								...
								name: this.title,
							    type:1,
                                inteltype: vue.detail.yuanxiaoleixing,
