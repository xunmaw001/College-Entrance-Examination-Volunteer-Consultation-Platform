				...
				<div :style='{"padding":"10px 0 0px 0px","boxShadow":"0px 0px 0px #eee","borderColor":"#e6e6e6","overflow":"hidden","borderRadius":"4px","flexWrap":"wrap","background":"rgba(255,255,255,.6)","borderWidth":"1px","display":"flex","position":"relative","borderStyle":"solid","justifyContent":"space-between"}'>
					...
					<div :style='{"minHeight":"500px","padding":"20px 20px 20px","margin":"0px 0px 0 0px","borderColor":"#e6e6e6","background":"rgba(255,255,255,.0)","borderWidth":"0px","flex":"1","width":"48%","borderStyle":"solid","order":"4"}'>
						...
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>招生标题：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.zhaoshengbiaoti}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
						...
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>总则：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.zongze}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>组织机构：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.zuzhijigou}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>学历学位证书：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.xuelixueweizhengshu}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>收费及其它：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.shoufeijiqita}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>录取原则：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.luquyuanze}}
							</div>
						</div>
				...
				<div class="layui-tab layui-tab-card" :style='{"boxShadow":"0 0px 0px rgb(0 0 0 / 30%)","padding":"10px","margin":"20px 0 0","borderColor":"#e6e6e6","overflow":"hidden","borderRadius":"4px","background":"rgba(255,255,255,1)","borderWidth":"1px","width":"100%","clear":"both","borderStyle":"solid","order":"10"}'>
					...
					<div :style='{"padding":"15px","background":"#fff"}' class="layui-tab-content">
						...
						<div class="layui-tab-item layui-show">
							<div v-html="detail.zhaoshengjihua"></div>
						</div>
		...
		<script>
			var vue = new Vue({
				...
				data: {
					...
					buynumber: 1,
					// 当前详情页表
					detailTable: 'zhaoshengjianzhang',
					baseurl: '',
					// 评论列表
					dataList: [],
					storeupFlag: 0,
				...
				methods: {
					...
					onAcrossTap(acrossTable,statusColumnName,tips,statusColumnValue){
						localStorage.setItem('crossTable',`zhaoshengjianzhang`);
					...
					storeUp() {
						layui.http.request('storeup/list', 'get', {
							...
							layui.http.requestJson('storeup/save', 'post', {
								...
								name: this.title,
							    type:1,
								picture:vue.detail.zhaoshengfengmian.split(",")[0],
								refid: this.detail.id,
								tablename: this.detailTable
							}, function(res) {
								layer.msg('收藏成功', {
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					...
					// 轮播图片
					vue.swiperList = vue.detail.zhaoshengfengmian ? vue.detail.zhaoshengfengmian.split(",") : [];
					// 轮播图
					vue.$nextTick(() => {
						carousel.render({
							elem: '#swiper',
