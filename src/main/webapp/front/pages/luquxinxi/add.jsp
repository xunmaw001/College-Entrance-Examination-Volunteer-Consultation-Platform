		...
		<div id="app">
			...
			<div class="data-add-container" :style='{"width":"90%","padding":"30px 0px 40px","margin":"10px auto","position":"relative","background":"rgba(255,255,255,.0)"}'>
				<form class="layui-form layui-form-pane add" lay-filter="myForm">
					...
					<div :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#c6ecc6","alignItems":"center","borderWidth":"0px","display":"flex","borderStyle":"solid"}' class="layui-form-item">
						<div :style='{"width":"120px","padding":"0 15px","lineHeight":"44px","color":"#3d74c0","textAlign":"right"}' class="label">封面：</div>
						...
						<button v-if="!ro.fengmian" :style='{"cursor":"pointer","border":"0","padding":"0px 20px","margin":"0","borderColor":"#86bae6","color":"#fff","minWidth":"80px","outline":"none","borderRadius":"0px","background":"#95c6ed","borderWidth":"1px","width":"auto","fontSize":"14px","lineHeight":"40px","borderStyle":"solid","height":"40px"}' type="button" class="layui-btn btn-theme" id="fengmianUpload">
							<i :style='{"margin":"0 10px 0 0","fontSize":"14px","color":"#fff","display":"inline-block"}' class="layui-icon">&#xe67c;</i>上传封面
						</button>
					</div>
					<div :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#c6ecc6","alignItems":"center","borderWidth":"0px","display":"flex","borderStyle":"solid"}' class="layui-form-item">
					...
					<div :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#c6ecc6","alignItems":"center","borderWidth":"0px","display":"flex","borderStyle":"solid"}' class="layui-form-item">
						<div :style='{"width":"120px","padding":"0 15px","lineHeight":"40px","color":"#3d74c0","textAlign":"right"}' class="label">录取分数</div>
						<select name="luqufenshu" id="luqufenshu" lay-filter="luqufenshu"  >
							<option value="">请选择</option>
							<option v-for="(item,index) in luqufenshu" v-bind:key="index" :value="item">{{item}}</option>
						</select>
					</div>
					<div :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#c6ecc6","alignItems":"center","borderWidth":"0px","display":"flex","borderStyle":"solid"}' class="layui-form-item">
						<div :style='{"width":"120px","padding":"0 15px","lineHeight":"40px","color":"#3d74c0","textAlign":"right"}' class="label">录取人数：</div>
						<input :style='{"padding":"0 10px","margin":"0","borderColor":"#d2e5fd","color":"#333","outline":"none","borderRadius":"4px","borderWidth":"1px","background":"#fff","width":"360px","fontSize":"14px","lineHeight":"40px","borderStyle":"solid","height":"40px"}' v-model="detail.luqurenshu" type="text" :readonly="ro.luqurenshu" name="luqurenshu" id="luqurenshu" autocomplete="off" class="layui-input">
					</div>
					<div :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#c6ecc6","alignItems":"center","borderWidth":"0px","display":"flex","borderStyle":"solid"}' class="layui-form-item">
					...
					<div :style='{"alignItems":"center","margin":"0 0 10px 0","display":"flex"}' class="layui-form-item">
						<div :style='{"width":"120px","padding":"0 15px","lineHeight":"44px","color":"#3d74c0","textAlign":"right"}' class="label">录取内容：</div>
						<textarea :style='{"padding":"0","boxShadow":"0 0 0px rgba(75,223,201,.5)","margin":"20px 0 20px","borderColor":"#ddd","backgroundColor":"rgba(255,255,255,.8)","borderRadius":"0","borderWidth":"1px","width":"88%","borderStyle":"solid","height":"auto"}' name="luquneirong" id="luquneirong">请输入录取内容</textarea>
					</div>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                        ...
                        if(o=='luqufenshu'){
                                vue.detail[o] = obj[o];
                                vue.ro.luqufenshu = true;
                                continue;
                        }
                        if(o=='luqurenshu'){
                                vue.detail[o] = obj[o];
                                vue.ro.luqurenshu = true;
                                continue;
                        }
                        if(o=='luquneirong'){
                                vue.detail[o] = obj[o];
                                vue.ro.luquneirong = true;
                                continue;
                        }
                        if(o=='fabushijian'){
                                vue.detail[o] = obj[o];
				...
				form.on('submit(*)', function(data) {
					...
					var luquneirong = tinymce.get('#luquneirong').getContent()
					data.luquneirong = luquneirong;
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('luquxinxi/list', 'get', {
                                        page: 1,
                                        limit: 10,
