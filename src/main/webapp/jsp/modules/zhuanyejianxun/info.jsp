		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					...
					<input id="chengyuanrenshu" name="chengyuanrenshu" class="form-control" v-model="ruleForm.chengyuanrenshu" readonly>
				</div>
				<div class="form-item">
					<label>研究方向</label>

					<input id="yanjiufangxiang" name="yanjiufangxiang" class="form-control" v-model="ruleForm.yanjiufangxiang" readonly>
				</div>
				...
				<div class="form-item-file">
					<label>专业内容</label>
					<script id="zhuanyeneirongEditor" type="text/plain" style="width:800px;height:230px;"></script>
	...
	<script>
		...
		function setContent(){
			if(ruleForm.zhuanyeneirong != null && ruleForm.zhuanyeneirong != 'null' && ruleForm.zhuanyeneirong != ''){
				var mes = '' + ruleForm.zhuanyeneirong;
				var zhuanyeneirongUeditor = UE.getEditor('zhuanyeneirongEditor');
				zhuanyeneirongUeditor.ready(function() {
					zhuanyeneirongUeditor.setContent(mes);
					zhuanyeneirongUeditor.setDisabled('fullscreen');
				});
			}
		}  
