...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">专业简讯管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>专业简讯列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th onclick="sort('chengyuanrenshu')">成员人数<i id="chengyuanrenshuIcon" class="fa fa-sort"></i></th>
						<th onclick="sort('yanjiufangxiang')">研究方向<i id="yanjiufangxiangIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var zhuanyefengmianCell  = document.createElement('td');

			            var zhuanyefengmianImg = document.createElement('img');
            zhuanyefengmianImg.setAttribute('src',item.zhuanyefengmian?(baseUrl+item.zhuanyefengmian.split(",")[0]):'');
			zhuanyefengmianImg.setAttribute('height',100);
			zhuanyefengmianImg.setAttribute('width',100);
			zhuanyefengmianCell.appendChild(zhuanyefengmianImg);


			row.appendChild(zhuanyefengmianCell);
			...
			var chengyuanrenshuCell  = document.createElement('td');

						 chengyuanrenshuCell.innerHTML = item.chengyuanrenshu;

			row.appendChild(chengyuanrenshuCell);
			var yanjiufangxiangCell  = document.createElement('td');

						 yanjiufangxiangCell.innerHTML = item.yanjiufangxiang;

			row.appendChild(yanjiufangxiangCell);
			var zhuanyeneirongCell  = document.createElement('td');
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("zhuanyejianxun/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function discussList(id) {
            ...
            window.location.href = "../discusszhuanyejianxun/list.jsp"
        }
		//清除会重复渲染的节点
        function clear(){
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"zhuanyejianxun");
