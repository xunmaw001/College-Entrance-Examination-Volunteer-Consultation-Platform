...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑专业名称</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>专业名称管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑专业名称</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>专业名称</label>
					<input name="zhuanyemingcheng" id="zhuanyemingcheng" name="zhuanyemingcheng" class="form-control" placeholder="请输入专业名称">
				</div>
	...
	<script>
		...
		var tableName = "zhuanyemingcheng";
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "zhuanyemingcheng/info/" + id,
		...
		function submit() {
			...
			if(validform() ==true && compare() == true){
				...
				if(crossrefid && crossuserid) {
					...
					http("zhuanyemingcheng/page","GET",{
						page:1,
						limit:10,
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("zhuanyemingcheng/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("zhuanyemingcheng/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("zhuanyemingcheng"+colName,"GET",{
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.zhuanyemingcheng != null && res.data.zhuanyemingcheng != ''){
						...
						$("#zhuanyemingcheng").attr('readonly','readonly');
					}
				}
			});  
            }
