...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑录取分数</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>编辑录取分数</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>录取分数</label>
					<input name="luqufenshu" id="luqufenshu" name="luqufenshu" class="form-control" placeholder="请输入录取分数">
				</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "luqufenshu/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("luqufenshu/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("luqufenshu/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("luqufenshu/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.luqufenshu != null && res.data.luqufenshu != ''){
						...
						$("#luqufenshu").attr('readonly','readonly');
					}
				}
			});  
            }
