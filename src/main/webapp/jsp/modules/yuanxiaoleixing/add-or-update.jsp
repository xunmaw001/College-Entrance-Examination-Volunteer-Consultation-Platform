...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑院校类型</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>院校类型管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑院校类型</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>院校类型</label>
					<input name="yuanxiaoleixing" id="yuanxiaoleixing" name="yuanxiaoleixing" class="form-control" placeholder="请输入院校类型">
				</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "yuanxiaoleixing/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("yuanxiaoleixing/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("yuanxiaoleixing/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("yuanxiaoleixing/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("yuanxiaoleixing"+colName,"GET",{
